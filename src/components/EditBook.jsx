    ...
    const updateBuku = async (e) => {
        ...
        try {
          ...
          // }
            ...
            await axios.patch(`http://localhost:5000/databuku/${id}`, requestData);
            navigate("/");
        } catch (error) {
            console.log(error);
        }
            ...
            <div className="column is-half">
                <form onSubmit={updateBuku}>
                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            <input type="number" className='input' value={stok} onChange={(e)=> setStok(parseInt(e.target.value))} placeholder='Stok' />
                        </div>
                    </div>
                    <div className="field">
